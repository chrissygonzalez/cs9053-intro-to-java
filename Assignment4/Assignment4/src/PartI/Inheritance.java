...
public class Inheritance {
	...
	public static void main(String[] args) {
		...
		Employee mary = new Employee("Mary", 53, 'F', 85000, "Manager", LocalDate.parse("2024-05-06"));
		...
		SpecialStudent joe = new SpecialStudent("Jim Slim", 25, 'F', "Electrical Engineering", LocalDate.parse("2024-05-06"));
